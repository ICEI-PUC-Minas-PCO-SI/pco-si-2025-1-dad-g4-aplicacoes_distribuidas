...
|RF-003| A aplicação deve permitir que os usuários filtrem produtos por categoria e faixa de preço. | Leni Rocha | Rota: /api/Products?nome={nome}&precoMin={valor}&precoMax={valor}&categoria={categoria} (GET)|
